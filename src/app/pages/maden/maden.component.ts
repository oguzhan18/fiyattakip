...
@Component({
  selector: 'app-maden',
  templateUrl: './maden.component.html',
  styleUrls: ['./maden.component.scss']
})
export class MadenComponent implements OnInit {
  emita: any;
  ...
  getemitaData() {
    ...
    //fetch('http://www.ormetsan.com/ajaxjsonreadv2.html?sector=0&language=tr&_=1642574412569')
